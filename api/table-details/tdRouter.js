...
router.patch('/res/:restaurant_id/:orderId/paid/:tid/:paidVia/:cash/:cash_change', token.verifyToken, tdController.mrkPaid);
...
router.patch('/available/:table_id', token.verifyToken, tdController.markAvailable);
